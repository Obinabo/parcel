      ...
      <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
          <div class="page-title d-flex">
            <h4><i class="icon-balance mr-2"></i> <span class="font-weight-semibold">About us</span></h4>
          </div>
        </div>
...
<div class="card">
        <div class="card-header header-elements-inline">
          <h6 class="card-title font-weight-semibold">Update About us page</h6>
        ...
        <div class="card-body">
          <form action="<?php admin_url('about');?>" method="post">
             <div class="form-group row">
                <label class="col-form-label col-lg-2">Title:</label>
                <div class="col-lg-10">
                  <input type="text" name="title" class="form-control" value="<?php echo $set2['a_title'];?>">
                </div>
              </div> 
              <div class="form-group row">
                <label class="col-form-label col-lg-2">Content:</label>
                <div class="col-lg-10">
                  <textarea type="text" name="body" class="tinymce form-control"><?php echo $set2['a_body'];?></textarea>
                </div>
              </div>                
