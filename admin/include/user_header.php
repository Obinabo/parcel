...
if(!isset($_SESSION['offshore_admin'])){
	...
	$admin=mysqli_fetch_array(mysqli_query($dbc, "SELECT * FROM admin WHERE password='".$_SESSION['offshore_admin']."'"));
	$username=$admin['username'];
	if($_SESSION['offshore_adminpass']!=$admin['password']){
...
<head>
	...
	<link rel="apple-touch-icon" sizes="76x76" href="../asset/<?php echo $logo['image_link2']; ?>">
	<link rel="icon" type="image/png" sizes="96x96" href="../asset/<?php echo $logo['image_link2']; ?>">
	...
	<script src="../asset/user/assets/js/countries.js"></script>
	<!-- /global stylesheets -->
